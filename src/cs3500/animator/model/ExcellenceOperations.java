...
public interface ExcellenceOperations {
   ...
   * instructions of the cs3500.animator.model. This function expects valid Positions, Dimensions, and Colors. This
   ...
   *                                  Instruction class) or if there is no shape in the cs3500.animator.model
  ...
  /**
   * Creates and adds a shape to the cs3500.animator.model. Expects only a name and a type to create the shape
   * object.
   *

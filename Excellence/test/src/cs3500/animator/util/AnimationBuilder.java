...
/**
 * An interface to parameterize an animation builder. This was supplied by course instructors and is
 * supposed to build animations from their files using our code.
 */

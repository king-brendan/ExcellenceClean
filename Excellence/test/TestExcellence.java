...
public class TestExcellence {
  ...
  public void testAddKeyFrame() {
    ...
    hwExample.addKeyframe("C", 120, new Position(50, 50),
            new Dimension(50, 50), Color.LIGHT_GRAY);

    Shape s = hwExample.getShapesAt(120).get(0);

    assertEquals(new Position(50, 50), s.getPosition());
    assertEquals(new Dimension(50, 50), s.getDimension());
    assertEquals(Color.LIGHT_GRAY, s.getColor());
    ...
    hwExample.addKeyframe("R", 5, new Position(100, 100),
            new Dimension(100, 50), Color.RED);

    assertFalse(hwExample.toText().contains("motion R 1 200.0 200.0 50.0 100.0 255 0 0   " +
            "  10 10.0 200.0 50.0 100.0 255 0 0"));
  ...
  public void testDeleteKeyFrame() {
    ...
    assertTrue(hwExample.toText().contains("motion C 80 440.0 370.0 120.0 60.0 0 255 0     " +
            "100 440.0 370.0 120.0 60.0 0 255 0"));

    assertEquals(2, hwExample.getShapesAt(100).size());

    hwExample.deleteKeyframe("C", 100);

    assertFalse(hwExample.toText().contains("motion C 80 440.0 370.0 120.0 60.0 0 255 0     " +
            "100 440.0 370.0 120.0 60.0 0 255 0"));

    assertEquals(1, hwExample.getShapesAt(100).size());

    initExamples();

    assertTrue(hwExample.toText().contains("motion C 70 440.0 370.0 120.0 60.0 5 60 73    " +
            " 80 440.0 370.0 120.0 60.0 0 255 0\n" +
            "motion C 80 440.0 370.0 120.0 60.0 0 255 0     100 440.0 370.0 120.0 60.0 0 255 0"));

    hwExample.deleteKeyframe("C", 80);
  ...
  public void testDeleteWithBadShape() {
    initExamples();

    hwExample.deleteKeyframe("T", 50);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testDeleteWithBadTick() {
    initExamples();

    hwExample.deleteKeyframe("C", 99);
  }
  ...
  public void testDeleteShape() {
    initExamples();
    hwExample.deleteShape("C");
    List<Shape> shapes = hwExample.getShapesAt(50);
  ...
  public void testAddInstruction() {
    ...
    assertEquals(2, hwExample.getKeyframes().get(t).size());
  }
